...
@FeignClient(name = "platformUserEducationProxy", url = "${app.cx.client.iam-services.url}")
public interface PlatformUserEducationProxy {

  @GetMapping(
      path = EndpointConstants.PATH_USER_EDUCATIONS,
      produces = MediaType.APPLICATION_JSON_VALUE)
  @ResponseStatus(value = HttpStatus.OK)
  List<PlatformUserEducationDto> list(
  ...
  @PostMapping(
      ...
      produces = MediaType.APPLICATION_JSON_VALUE)
  @ResponseStatus(value = HttpStatus.OK)
  PlatformUserEducationDto create(
      @PathVariable(name = PVAR_ALIAS) @Valid @NotBlank String alias,
  ...
  @PutMapping(
      ...
      produces = MediaType.APPLICATION_JSON_VALUE)
  @ResponseStatus(value = HttpStatus.OK)
  PlatformUserEducationDto update(
      @PathVariable(name = PVAR_ALIAS) @Valid @NotBlank String alias,
